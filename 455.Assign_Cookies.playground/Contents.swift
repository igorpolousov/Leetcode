...
func findContentChildren(_ g: [Int], _ s: [Int]) -> Int {
       ...
       var s = s.sorted()
       var x = 0
       for i in 0..<s.count where x < g.count{
           if g[x] <= s[i]{
               x += 1
           }
       }
